...
- Una muestra de datos de *series temporales* está formada por
  observaciones de variables en periodos de tiempo consecutivos.
...
- En series temporales, el paso del tiempo proporciona un orden natural de las observaciones están ordenadas.
