...
- Grandes diferencias en las estimaciones apuntarían al incumplimiento
  de otras de las hipótesis de Gauss-Markov.
...
- Si sigue existiendo heteroscedasticidad después de la estimación
  MCP(F), puede usarse una matriz de covarianzas robusta.
