...
Esto es un auténtico atropello y las cosas no van a quedar así.
...
#+MATS: figcol fig-08b_1027-ar1-p8-corr-*.pdf 0.5

Un autocorrelograma se balanceaba sobre la tela de una araña.
